...
var $help_node body = <$ctext_frob, [[<$format, ["p", [], [], 'do_p]>, "Data is stored in a ", <$format, ["i", [], [<$format, ["link", [["node", "$help_coldc_vars"]], ["variable"], 'do_link]>], 'do_i]>, " through an assignment. Assignments can either be ", <$format, ["i", [], ["Simple"], 'do_i]>, ", ", <$format, ["i", [], ["Scattered"], 'do_i]>, ", ", <$format, ["i", [], ["Dual Role"], 'do_i]>, " or ", <$format, ["i", [], ["Default"], 'do_i]>, ". Simple Assignments store the result of an expression to a single variable. A Scatter Assignment stores each element in the result of a list expression across multiple variables. Dual Role Assignments join another operator and the simple assignment operator into one for the purpose of simplicity and optimizing, such as ", <$format, ["tt", [], ["+="], 'do_tt]>, " which is both the addition operator and the assignment operator. Default assignments only assign the value if the current value of the variable is false. More information can be found in each section:", <$format, ["p", [], [], 'do_p]>, <$format, ["ul", [], [<$format, ["li", [], [<$format, ["link", [["node", "$help_coldc_simple_assign"]], ["Simple Assignments"], 'do_link]>], 'do_li]>, <$format, ["li", [], [<$format, ["link", [["node", "$help_coldc_scatter_assign"]], ["Scatter Assignments"], 'do_link]>], 'do_li]>, <$format, ["li", [], [<$format, ["link", [["node", "$help_coldc_dual_assign"]], ["Dual Role Assignments"], 'do_link]>], 'do_li]>, <$format, ["li", [], [<$format, ["link", [["node", "$help_coldc_default_assign"]], ["Default Assignments"], 'do_link]>], 'do_li]>], 'do_ul]>], #[['this, $help_coldc_assign]]]>;
